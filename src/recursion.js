...
var reverse = function(string) {
  if (string.length === 0) {
    ...
    return reverse(string.substring(1)) + string.slice(0, 1);
  }
};
...
var multiply = function(x, y) {
  ...
  if (y === 1) {
    ...
    return oneNeg ? -(x + multiply(x, y - 1)) : x + multiply(x, y - 1);
  }
};
...
var reverseArr = function(array) {
  ...
  // must use recursion
  // edge case - empt array
  /* 
    1. create empty array result
    2. set base case to array empty
    3. push result of pop array to result
    4. return reverseArr slice -1
 ...
 return result.concat(reverseArr(array.slice(0)));
};
...
var fizzBuzz = function(n) {
  // input: upper bound inclusive of result to call of fizzBuzz
  // output: array of integers from 1 to n with multiples of 3 sub Fizz etc
  // must use recursion
  // edge case n = 1
  let result = [];
  if (n === 0) {
